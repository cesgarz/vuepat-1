...
<p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #74787E; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">Recibes este Correo porque te has inscrito en el sistema de registro "VUELTA A LA PATRIA". Da click al siguiente boton para completar con el registro:</p>
...
en tu navegador: <a href="{{ url('/usuario/verificar/' . $co_confirmacion) }}" style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #3869D4;">{{ url('/usuario/verificar/' . $co_confirmacion) }}</a></p>
        </td>
    </tr>
</table>
