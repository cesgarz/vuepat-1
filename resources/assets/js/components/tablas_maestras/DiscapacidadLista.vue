    ...
    <v-container fluid grid-list-md text-xs-center>
        ...
        <v-card>
            ...
            <template slot="items" slot-scope="item">
                ...
                <td class="text-xs-left">{{ item.item.nb_discapacidad }}</td>
                <td class="text-xs-left">{{ item.item.tipo_discapacidad.nb_tipo_discapacidad }}</td>
        ...
        <form-container :nb-accion="nb_accion" :modal="modal" @cerrarModal="cerrarModal">
            <discapacidad-form :accion="accion" :item="item" @cerrarModal="cerrarModal"></discapacidad-form>
        </form-container>

        <dialogo 
            :dialogo="dialogo" 
            :mensaje="'Desea Eliminar la Discapacidad: ' + item.nb_discapacidad "
            @delItem="delItem"
            @delCancel="delCancel"
        >
        </dialogo>
...
export default {
    ...
    return {
        headers: [
        { text: 'Nombre',   value: 'nb_discapacidad' },
        { text: 'Tipo',     value: 'tipo_discapacidad.nb_tipo_discapacidad' },
    ...
    methods:
    {
        ...
        delItem(){
            axios.delete('/api/v1/discapacidad/'+this.item.id_discapacidad)
            .then(respuesta => {
