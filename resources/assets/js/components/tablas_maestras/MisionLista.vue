    ...
    <v-container fluid grid-list-md text-xs-center>
        ...
        <v-card>
            ...
            <template slot="items" slot-scope="item">
                ...
                <td class="text-xs-left">{{ item.item.nb_mision }}</td>
        ...
        <dialogo 
            :dialogo="dialogo" 
            :mensaje="'Desea Eliminarla Misión: ' + item.nb_mision "
            @delItem="delItem"
            @delCancel="delCancel"
        >
        </dialogo>
...
export default {
    ...
    methods:
    {
        ...
        delItem(){
            axios.delete('/api/v1/mision/'+this.item.id_mision)
            .then(respuesta => {
