    ...
    <v-container fluid grid-list-md text-xs-center>
        ...
        <v-card>
            ...
            <template slot="items" slot-scope="item">
                ...
                <td class="text-xs-left">{{ item.item.nb_sector }}</td>
        ...
        <dialogo 
            :dialogo="dialogo" 
            :mensaje="'Desea Eliminar el Sector: ' + item.nb_sector "
            @delItem="delItem"
            @delCancel="delCancel"
        >
        </dialogo>
...
export default {
    ...
    methods:
    {
        ...
        delItem(){
            axios.delete('/api/v1/sector/'+this.item.id_sector)
            .then(respuesta => {
