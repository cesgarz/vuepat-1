...
-- ----------------------------
-- Sequence structure for persona_empleo_id_persona_empleo_seq
-- ----------------------------
DROP SEQUENCE IF EXISTS "public"."persona_empleo_id_persona_empleo_seq";
CREATE SEQUENCE "public"."persona_empleo_id_persona_empleo_seq" 
INCREMENT 1
MINVALUE  1
MAXVALUE 9223372036854775807
START 1
...
CREATE TABLE "public"."estudio" (
  ...
  "tx_titulo" varchar(100) COLLATE "pg_catalog"."default",
  "tx_observaciones" varchar(100) COLLATE "pg_catalog"."default",
  "id_status" int4 NOT NULL,
  "id_usuario" int4 NOT NULL,
  "fe_creado" timestamp(6),
...
INSERT INTO "public"."parentesco" VALUES (1, 'Hijo/Hija', NULL, 1, 1, NULL, NULL);
INSERT INTO "public"."parentesco" VALUES (2, 'Esposo/Esposa', NULL, 1, 1, NULL, NULL);
INSERT INTO "public"."parentesco" VALUES (3, 'Madre', NULL, 1, 1, NULL, NULL);
INSERT INTO "public"."parentesco" VALUES (4, 'Padre', NULL, 1, 1, NULL, NULL);
INSERT INTO "public"."parentesco" VALUES (5, 'Abuelo/Abuela', NULL, 1, 1, NULL, NULL);
INSERT INTO "public"."parentesco" VALUES (6, 'Tia/Tio', NULL, 1, 1, NULL, NULL);
INSERT INTO "public"."parentesco" VALUES (7, 'Sobrino/Sobrina', NULL, 1, 1, NULL, NULL);
...
-- Records of persona
-- ----------------------------
INSERT INTO "public"."persona" VALUES (10, 'sdfsf', 'sfsdf', '14214124', 'M', '2018-08-02 00:00:00', 1, 1, NULL, NULL, NULL, 1, 1, '2018-08-26 19:29:50', '2018-08-26 19:29:50');
INSERT INTO "public"."persona" VALUES (11, 'FAFSA', 'ASFAFA', '34234234', 'F', '2018-08-01 00:00:00', 1, 1, NULL, NULL, NULL, 1, 1, '2018-08-26 19:56:32', '2018-08-26 19:56:32');
INSERT INTO "public"."persona" VALUES (15, 'luis', 'yustiz', '7676787', 'M', '2018-08-06 00:00:00', 1, 2, NULL, NULL, NULL, 1, 1, '2018-08-26 22:33:43', '2018-08-26 22:33:43');
INSERT INTO "public"."persona" VALUES (6, 'LUIS DANIEL', 'YUSTIZ AZUAJE', '13479149', 'M', '2018-08-16 22:41:51', 1, 99, NULL, NULL, NULL, 1, 1, NULL, NULL);
...
-- ----------------------------
-- Table structure for persona_empleo
-- ----------------------------
DROP TABLE IF EXISTS "public"."persona_empleo";
CREATE TABLE "public"."persona_empleo" (
  "id_persona_empleo" int4 NOT NULL DEFAULT nextval('persona_empleo_id_persona_empleo_seq'::regclass),
  "id_persona" int4 NOT NULL,
  "tx_empresa" varchar(100) COLLATE "pg_catalog"."default",
  "tx_cargo" varchar(100) COLLATE "pg_catalog"."default",
  "nu_tiempo" int4,
...
-- ----------------------------
-- Records of persona_empleo
-- ----------------------------
INSERT INTO "public"."persona_empleo" VALUES (5, 6, 'AVIACION', 'SECRETARIO', 7, 3, NULL, 1, 1, '2018-08-27 03:06:56', '2018-08-27 03:18:47');
INSERT INTO "public"."persona_empleo" VALUES (6, 6, 'POLAR', 'MONTCARGA', 12, 3, NULL, 1, 1, '2018-08-27 03:19:21', '2018-08-27 03:19:21');
...
CREATE TABLE "public"."recurso" (
  "id_recurso" int4 NOT NULL DEFAULT nextval('recursos_id_recursos_seq'::regclass),
  "nb_recurso" varchar(50) COLLATE "pg_catalog"."default" NOT NULL,
  "tx_observaciones" varchar(100) COLLATE "pg_catalog"."default",
  "id_status" int4 NOT NULL,
  "id_usuario" int4 NOT NULL,
  "fe_creado" timestamp(6),
...
-- Records of recurso
-- ----------------------------
INSERT INTO "public"."recurso" VALUES (1, 'Propios', NULL, 1, 1, NULL, NULL);
INSERT INTO "public"."recurso" VALUES (2, 'Crédito', NULL, 1, 1, NULL, NULL);
INSERT INTO "public"."recurso" VALUES (3, 'Prestamo', NULL, 1, 1, NULL, NULL);
INSERT INTO "public"."recurso" VALUES (4, 'Otros', NULL, 1, 1, NULL, NULL);
...
INSERT INTO "public"."sector" VALUES (18, 'Otro', NULL, 1, 1, NULL, NULL);
...
SELECT setval('"public"."persona_empleo_id_persona_empleo_seq"', 7, true);
SELECT setval('"public"."persona_empresa_id_persona_empresa_seq"', 3, false);
SELECT setval('"public"."persona_id_persona_seq"', 16, true);
...
SELECT setval('"public"."sector_id_sector_seq"', 19, true);
...
-- ----------------------------
-- Uniques structure for table persona_empleo
-- ----------------------------
ALTER TABLE "public"."persona_empleo" ADD CONSTRAINT "uk_persona_empresa" UNIQUE ("id_persona", "tx_empresa");

-- ----------------------------
-- Primary Key structure for table persona_empleo
-- ----------------------------
ALTER TABLE "public"."persona_empleo" ADD CONSTRAINT "pk_id_persona_empleo" PRIMARY KEY ("id_persona_empleo");
...
-- ----------------------------
-- Uniques structure for table recurso
-- ----------------------------
ALTER TABLE "public"."recurso" ADD CONSTRAINT "uk_nb_recursos" UNIQUE ("nb_recurso");

-- ----------------------------
-- Primary Key structure for table recurso
-- ----------------------------
ALTER TABLE "public"."recurso" ADD CONSTRAINT "pk_id_recursos" PRIMARY KEY ("id_recurso");
